...
## 3. 🏆 회의 MVP 선정
- **베스트 아이디어**: 가장 가치 있는 아이디어 (${hasSpeakers ? '발언자 포함' : '내용 인용'})
- **팀 분위기 기여**: ${hasSpeakers ? '화합에 기여한 참가자' : '화합에 기여한 발언 패턴'}
...
## 5. 🤖 AI 개입 내역 정리
개입 횟수와 맥락·내용·효과. 없으면 "이번 회의에서 AI 자동 개입 없음".
